...
snoremap  "_c
nnoremap \sn :UltiSnipsEdit
nmap gx <Plug>NetrwBrowseX
nnoremap mk :!ampl % > %:r.output 
...
set hlsearch
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-pencil/,~/.vim/plugged/vimtex/,~/.vim/plugged/vim-template/,~/.vim/plugged/lightline.vim/,~/.vim/plugged/gruvbox/,~/.vim/plugged/ultisnips/,~/.vim/plugged/vim-snippets/,~/.vim/plugged/tex-conceal.vim/,~/.vim/plugged/ncm2/,~/.vim/plugged/nvim-yarp/,~/.vim/plugged/ncm2-bufword/,~/.vim/plugged/ncm2-path/,~/.vim/plugged/ncm2-jedi/,~/.fzf/,~/.vim/plugged/fzf.vim/,~/.vim/plugged/tabular/,~/.vim/plugged/vim-markdown/,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/plugged/vimtex/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/tex-conceal.vim/after,~/.vim/plugged/tabular/after,~/.vim/plugged/vim-markdown/after,~/.vim/after
set shiftwidth=4
set spelllang=en_us
...
badd +1 knap2.run
badd +18 knapsack.py
badd +1 instances/knapsack8.dat
badd +1 knapsack.run
args knapsack.mod
edit knapsack.py
...
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python' shellescape(@%, 1)
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
